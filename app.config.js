...
export default {
  ...
  staticUrl: {
    ...
    navBar: {
      // 正方形 Logo 160*160
      logo: 'https://vkceyugu.cdn.bspapp.com/VKCEYUGU-0971f295-ba06-4d1c-8c5f-e03738f37c87/ea0131e5-70ff-48d3-a5c4-73b4d1d08170.png',
      // 长方形 Logo 224*160
      logo1:
        'https://vkceyugu.cdn.bspapp.com/VKCEYUGU-0971f295-ba06-4d1c-8c5f-e03738f37c87/ea0131e5-70ff-48d3-a5c4-73b4d1d08170.png',
      // 横幅 Logo 480*100
      logo2:
        'https://vkceyugu.cdn.bspapp.com/VKCEYUGU-0971f295-ba06-4d1c-8c5f-e03738f37c87/ea0131e5-70ff-48d3-a5c4-73b4d1d08170.png',
    },
  ...
  globalErrorCode: {
    ...
    'cloudfunction-unusual-timeout':
      '请求超时，但请求还在执行，请重新进入页面。',
    // 请求超时（真正的请求超时）
